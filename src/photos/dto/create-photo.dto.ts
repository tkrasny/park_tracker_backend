...
export class CreatePhotoDto {
  ...
  @ApiProperty({ description: 'ID of the park visit this photo is associated with', required: false })
  @IsUUID()
  @IsOptional()
  visitId?: string;

  @ApiProperty({ description: 'ID of the hike record this photo is associated with', required: false })
  @IsUUID()
  @IsOptional()
  hikeRecordId?: string;
} 