...
export class HikeRecord {
  @ApiProperty({ description: 'Unique identifier for the hike record', example: '123e4567-e89b-12d3-a456-426614174000' })
  ...
  @ApiProperty({ description: 'Duration of the hike in hours', example: 5.5, required: false })
  @Column('float', { nullable: true })
  duration: number;

  @ApiProperty({ description: 'Distance hiked in miles', example: 8.2, required: false })
  @Column('float', { nullable: true })
  distance: number;
